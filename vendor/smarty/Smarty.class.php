...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     */
    public static $_muted_directories = array('./build/' => null,'./cache/'=> null);
     ...
     * @var array
     */
    private $template_dir = array('./app/views/');
     ...
     * @var string
     */
    public $joined_template_dir = './app/views/';
    ...
    public function __construct()
    {
        ...
        if ($this->template_dir[0] !== './app/template/' || isset($this->template_dir[1])) {
        ...
        if ($this->compile_dir !== './build/') {
            unset(self::$_muted_directories['./build/']);
